document.addEventListener('DOMContentLoaded', function () {
    ...
    rappelCheckbox.addEventListener('change', function () {
        // Active ou désactive les cases à cocher de disponibilités en fonction de "Être rappelé(e)"
        disponibiliteCheckboxes.forEach(cb => {
            cb.disabled = this.checked; // Désactive si coché, mais active "Autre"
        });
        // Si "Être rappelé(e)" est coché, active la case "Autre"
