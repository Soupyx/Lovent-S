document.getElementById('contactForm').addEventListener('submit', function (event) {
    ...
    // COMMENTÉ: Cette vérification du CAPTCHA est temporairement désactivée pour les tests.
...
// Valider que les champs obligatoires sont remplis avant de permettre l'envoi
document.getElementById('contactForm').addEventListener('submit', function (event) {
    event.preventDefault(); // Empêche le rechargement de la page
