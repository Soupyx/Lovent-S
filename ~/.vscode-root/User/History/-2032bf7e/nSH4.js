document.addEventListener('DOMContentLoaded', function () {
    ...
    // Activer/Désactiver l'input "Autre (précisez)" en fonction de la case à cocher "Autre"
    ...
    dispoAutreCheckbox.addEventListener('change', function () {
        autrePrecisezInput.disabled = !this.checked; // Active ou désactive le champ texte "Autre (précisez)"
    });
